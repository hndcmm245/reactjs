        ...
        <div className="container row">
          ...
          <div className="col c-12 m-0 l-0">
            <div className="header_content">
              ...
              <div className="header_content">
                ...
                <i className="fa-regular fa-bag-shopping fa-lg icon" style={{ position: 'relative' }}>
          ...
          <div className="c-0 m-0 l-8">
            <ul className="header_content">
              <li><a href="nhanam1.html">Trang chủ</a></li>
              <li className="dropdown">
                <a className="list" href="https://nhanam.vn/lien-he">Tin sách</a>
                <div className="dropdown_list" style={{ minWidth: '250px' }}>
